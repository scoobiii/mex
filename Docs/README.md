...
header.fixed-header {
    position: fixed;
    top: 10px; /* Pequena distância do topo */
    left: 50%;
...
header.fixed-header nav {
    background-color: rgba(106, 13, 173, 0.9); /* Roxinho com transparência */
    padding: 10px 20px;
    border-radius: 20px; /* Cantos arredondados */
    box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); /* Sombra para efeito de elevação */
    display: inline-block; /* Para centralizar o nav */
}
...
#economize .container {
    background-image: url('images/mex_economia.png');
    background-size: cover; /* Ajusta o tamanho para cobrir todo o conteúdo */
    background-position: center; /* Centraliza a imagem */
    padding: 20px; /* Preenchimento interno */
    color: #fff; /* Cor do texto */
    text-align: center; /* Alinha o texto ao centro */
    background-color: rgba(106, 13, 173, 0.8); /* Cor de fundo com transparência */
}
...
#energia-limpa .features {
    display: flex;
    justify-content: space-around;
    flex-wrap: wrap;
}

#energia-limpa .feature {
    width: 30%;
    min-width: 200px;
    text-align: center;
    margin-bottom: 20px;
...
#energia-limpa .feature img {
    max-width: 100%;
    height: auto;
    margin-bottom: 10px;
}

#energia-limpa .feature h3 {
    font-size: 1.5em;
    margin-bottom: 10px;
}

#energia-limpa .feature p {
    font-size: 1em;
}
...
/* Estilo para Elementos Personalizados */
.custom-card {
    border: 1px solid #ccc;
    border-radius: 10px;
    padding: 20px;
